"""
Automated Image Captioning Script
This script is part of IBM Generative AI Applications project.
Automatically generates captions for web images using a pretrained BLIP model. 
"""
...
with open("automate_url_captions.txt", "w", encoding="utf-8") as caption_file:
